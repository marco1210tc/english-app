...
@section('content')
    ...
    <section class="mb-6">
        <div class="rounded-3xl bg-surface/95 border border-neutral-200/70 px-4 py-4 sm:px-5 sm:py-4 shadow-sm flex flex-col sm:flex-row items-start sm:items-center gap-4">
