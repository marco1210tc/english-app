    ...
    <div class="flex w-full max-w-4xl bg-white shadow-lg rounded-2xl overflow-hidden">
            ...
            <div class="absolute top-0 left-10 transform -rotate-6 transition-transform hover:scale-105">
              <div class="p-2 bg-white rounded-xl shadow-lg">
                <img src="https://mma.prnewswire.com/media/1087274/Studycat_Logo.jpg?p=facebook" alt="Student 1"
                  class="w-40 h-28 object-cover rounded-md border-4 border-green-300">
              </div>
            </div>
            <div class="absolute bottom-0 right-10 transform rotate-6 transition-transform hover:scale-105">
              <div class="p-2 bg-white rounded-xl shadow-lg">
                <img
                  ...
                  alt="Student 2" class="w-40 h-28 object-cover rounded-md border-4 border-green-300">
              </div>
            </div>
      ...
      <div class="w-full md:w-1/2 p-8 md:p-12 flex items-center justify-center">
        <div class="w-full max-w-sm">
          <h2 class="text-2xl font-bold text-gray-800 mb-8 text-center uppercase">Please Login</h2>

          <form action="{{route('login')}}" method="POST" class="space-y-6">
            @csrf
            <div>
              <label for="username" class="block text-gray-600 text-sm font-bold tracking-wider mb-2 uppercase"> USERNAME </label>
              <input id="username" name="username" type="text" placeholder="Type your username"
                class="w-full px-4 py-3 bg-gray-100 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary-500 transition">
              <p class="text-xs text-red-600 mt-1">{{ $errors->first('username') }}</p>
            </div>

            <div>
              <label for="password" class="block text-gray-600 text-sm font-bold tracking-wider mb-2">PASSWORD</label>
              <input id="password" name="password" type="password" placeholder="Insert your password"
                class="w-full px-4 py-3 bg-gray-100 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-greenmain transition">
